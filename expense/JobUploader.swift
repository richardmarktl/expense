...
struct JobUploader {
    ...
    static func upload(_ job: Job, changedOrders: [Order], changedAttachments: [Attachment], changedPayments: [Payment]) -> Observable<Job> {
        // Upload job first
    ...
    ///   - changedPayments: changed payments
    /// - Returns: a Observable returning a job
    static func upload(_ job: Job, sendTo: MailParameter, changedOrders: [Order], changedAttachments: [Attachment], changedPayments: [Payment]) -> Observable<Job> {
    ...
    /// - Returns: a Observable returning a job
    static func uploadResources(observable: Observable<Job>, orders: [Order], attachments: [Attachment], payments: [Payment]) -> Observable<Job> {
    ...
    static func delete(_ job: Job) -> Observable<Job> {
        var obs: Observable<Job>
