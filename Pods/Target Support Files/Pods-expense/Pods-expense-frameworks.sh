...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CoreDataExtensio/CoreDataExtensio.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/ImageStorage/ImageStorage.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/InvoiceBotSDK/InvoiceBotSDK.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SupportEmail/SupportEmail.framework"
