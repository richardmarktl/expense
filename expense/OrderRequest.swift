...
struct OrderRequest {
    ...
    static func upload(_ item: Order, for job: Job) -> Observable<Order> {
    ...
    static func upload(_ items: [Order], for job: Job) -> Observable<Void> {
    ...
    /// - Returns: obs when done
    static func delete(_ item: Order) -> Observable<Order> {
    ...
    static func load(for path: Path, updatedAfter: String?, updateIn context: NSManagedObjectContext) -> Observable<PagedResult<Order>> {
