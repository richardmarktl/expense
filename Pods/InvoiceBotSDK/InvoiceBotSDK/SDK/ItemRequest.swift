...
public struct ItemRequest {
    ...
    public static func upload(_ item: Item) -> Observable<Item> {
    ...
    public static func delete(_ item: Item) -> Observable<Item> {
    ...
    public static func load(updatedAfter: String?, updateIn context: NSManagedObjectContext) -> Observable<PagedResult<Item>> {
