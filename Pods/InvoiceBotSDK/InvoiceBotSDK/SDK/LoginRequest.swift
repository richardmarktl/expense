...
public struct AccountRequest {
    ...
    public static func login(with email: String) -> Observable<Void> {
        return ApiProvider.request(Api.login(email: email)).mapToVoid()
    }
    
    public static func loginNormal(with email: String, name: String, password: String) -> Observable<String> {
    ...
    public static func register(with email: String, name: String) -> Observable<Void> {
    ...
    public static func registerActive(with email: String, name: String, password: String) -> Observable<Void> {
    ...
    public static func validate(uid: String, token: String) -> Observable<String> {
    ...
    public static func uploadProState(isPro: Bool) -> Observable<Void> {
        return ApiProvider.request(Api.updatePro(isPro: isPro)).mapToVoid()
    }
    
    public static func load(_ account: Account, updatedAfter: String?, useDefaultMapper: Bool = false) -> Observable<Account> {
    ...
    public static func upload(_ item: Account) -> Observable<Account> {
    ...
    public static func uploadTrail(for account: Account, started: Date, ended: Date) -> Observable<Account> {
        return ApiProvider.request(Api.updateAccountTrail(trailStart: started, trailEnded: ended)).map(updateObjectWithJSON(account))
    }
    
    public static func uploadLogo(for account: Account) -> Observable<Account> {
        ...
        return ImageStorage.loadImage(in: FileSystemDirectory.imageAttachments, for: filename).observeOn(background).map({ (storageItem) -> Data? in
    ...
    public static func deleteLogo(for account: Account) -> Observable<Account> {
