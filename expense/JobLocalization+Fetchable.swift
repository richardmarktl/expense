...
extension JobLocalization: Fetchable, Createable {
    ...
    static func create(in context: NSManagedObjectContext) -> JobLocalization {
    ...
    static func localization(for language: String?, in context: NSManagedObjectContext) -> JobLocalization? {
    ...
    static func localization(for language: Language, in context: NSManagedObjectContext) -> JobLocalization? {
