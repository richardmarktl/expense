...
extension Order: Fetchable, Createable {
    ...
    public static func create(in context: NSManagedObjectContext) -> Order {
    ...
    public static func create(from order: Order, in context: NSManagedObjectContext) -> Order {
