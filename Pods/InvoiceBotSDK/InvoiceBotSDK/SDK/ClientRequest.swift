...
public struct ClientRequest {
    ...
    public static func upload(_ item: Client) -> Observable<Client> {
    ...
    public static func delete(_ item: Client) -> Observable<Client> {
    ...
    public static func load(updatedAfter: String?, updateIn context: NSManagedObjectContext) -> Observable<PagedResult<Client>> {
